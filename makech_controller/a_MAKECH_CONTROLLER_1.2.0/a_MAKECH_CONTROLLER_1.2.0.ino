...
typedef struct Robot_state{
  float height = 200;                      // Actual height of CM (center of mass) of the Robot [mm]
  float transl_x = 0;                      // CM translation in X axis [mm]
  float transl_y = 0;                      // CM translation in y axis [mm]
