...
void gait_gen(float ratio = gait.sync_ratio, float stancePeriod = gait.stance_period, float swingPeriod = gait.swing_period, float constantX = gait.step_length_x, float constantY = gait.step_length_y, float constantYaw = gait.yaw_angle, float constantPitch = gait.pitch_angle);
