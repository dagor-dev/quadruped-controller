...
void crawl(float ratio, float stancePeriod, float swingPeriod, float constantX, float constantY, float constantYaw, float constantPitch){
  ...
  gaitKinematics (0, fr_x, -fr_y, fr_z, fr_yaw, pitchAngle, 0, stepPeriod_fr, 1, 1);   // front right leg
  gaitKinematics (1, fl_x, -fl_y, fl_z, fl_yaw, pitchAngle, 0, stepPeriod_fl, 1, 1);   // front left leg
  gaitKinematics (2, br_x, -br_y, br_z, br_yaw, pitchAngle, 0, stepPeriod_br, 1, 1);   // back right leg
  gaitKinematics (3, bl_x, -bl_y, bl_z, bl_yaw, pitchAngle, 0, stepPeriod_bl, 1, 1);   // back left leg
...
void trot(float trotPeriod, float constantX, float constantY, float constantYaw, float constantPitch){
  ...
  gaitKinematics (0, fr_x, -fr_y, legLength1, fr_yaw, pitchAngle, 0, trotPeriod, 0.5, 0);   // front right leg
  gaitKinematics (1, fl_x, -fl_y, legLength2, fl_yaw, pitchAngle, 0, trotPeriod, 0.5, 0);   // front left leg
  gaitKinematics (2, br_x, -br_y, legLength2, br_yaw, pitchAngle, 0, trotPeriod, 0.5, 0);   // back right leg
  gaitKinematics (3, bl_x, -bl_y, legLength1, bl_yaw, pitchAngle, 0, trotPeriod, 0.5, 0);   // back left leg
